...
public class cardAdapter5 extends BaseAdapter {
    ...
    public cardAdapter5(ArrayList<myDate> arrMyDate, ArrayList<String> arrAmount, ArrayList<String> arrOrderCode, Activity ctx) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        View myrow= inflater.inflate(R.layout.cardviewdetails5,null,true);

        TextView txtOrderPPU = myrow.findViewById(R.id.txtorderPPU);
        txtOrderPPU.setText(this.arrMyDate.get(position).getDay()+"/"+this.arrMyDate.get(position).getMonth()+"/"+this.arrMyDate.get(position).getYear());
